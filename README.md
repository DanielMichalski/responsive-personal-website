...
In order to run the website please run the below command and in your browser type URL defined in the [Localhost environment](#localhost-environment) section.
```bash
